          ...
          >
            ...
            <div className="submits">
              ...
              <div className="socials d-flex justify-content-center column-gap-3">
                ...
                <Link to="https://accounts.google.com/o/oauth2/v2/auth?client_id=
                462197463271-ri7rr1533ocspldisdmgckvvtovp8pn2.apps.googleusercontent.com&redirect_uri=
                http://localhost:3004/accounts/google/login/callback/&response_type=
                code&scope=openid%20email%20profile" target="_blank">
                  <img src={google} alt="" />
                </Link>
              </div>
            </div>
